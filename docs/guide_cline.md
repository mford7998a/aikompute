...
This guide provide specific instructions for connecting **Cline** (formerly Claude-Dev) to the AIKompute AI Inference Gateway. 

Using the **Native Anthropic Provider** in Cline ensures 100% reliable tool-calling and eliminates extra XML noise in Claude responses.
...
## Troubleshooting
If you see **"API Request Failed"**, double-check that your Base URL does not end in `/v1` for the Anthropic/Gemini providers. The `/v1` suffix is ONLY for the "OpenAI Compatible" provider.
